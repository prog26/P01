...
<form action="../controllers/promptController.php" method="POST" class="main-form">
    ...
    <div>
        <label>Titre</label>
        <input type="text" name="title" value="<?= htmlspecialchars($prompt['title']) ?>" placeholder="Titre du prompt" required>
    </div>
    ...
    <div>
        <label>Contenu</label>
        <textarea name="content" rows="8" placeholder="Contenu du prompt..." required><?= htmlspecialchars($prompt['content']) ?></textarea>
    </div>
